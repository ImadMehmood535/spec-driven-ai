...
- [ ] Permissions can be **removed** from a role, behind a confirmation (FR-UI4, FR-RP2)
...
Removal semantics follow whatever `role-permission-assignment` decided — delete the link or
deactivate it. Match the backend rather than inventing a second model.
